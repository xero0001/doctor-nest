...
export default async function MarketingRegistrationPage() {
  ...
  return (
    <MarketingWorkspace activeSection="REGISTER">
      ...
      <main className="min-h-0 flex-1 overflow-y-auto bg-[#f3f7ff] px-8 py-12">
        <div className="mx-auto w-full max-w-[1080px]">
            ...
            <div className="flex items-end justify-between gap-6 px-5">
              <div>
                ...
                <p className="mt-2 text-sm text-[#929aac]">
                  치료태그가 입력된 고객 유형별로 카카오톡 브랜드 메시지를
                  보낼 수 있습니다.
                </p>
              </div>
              <button
                ...
                className="h-10 shrink-0 cursor-not-allowed rounded-xl bg-[#168ff0] px-6 text-sm font-extrabold text-white shadow-sm"
              >
                등록
              </button>
            </div>

            <div className="mt-5 flex min-h-[240px] flex-col items-center justify-center rounded-[24px] border border-[#e3ebf5] bg-[#e9f2fd] px-6 text-center">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-white/80 text-[#168ff0] shadow-sm">
              ...
              <button
                ...
                disabled
                title="마케팅 캠페인 등록 기능은 준비 중입니다."
                className="mt-6 flex h-10 cursor-not-allowed items-center gap-2 rounded-xl bg-[#168ff0] px-6 text-sm font-extrabold text-white shadow-sm"
              >
          ...
          <section
            ...
            className="mt-6 rounded-[24px] border border-[#e6eaf1] bg-white px-7 py-6 shadow-[0_8px_28px_rgba(72,91,126,0.04)]"
          >
            <h2
            ...
            <ul className="mt-4 space-y-3 pl-5 text-sm leading-6 text-[#727c91] marker:text-[#727c91]">
              ...
              <li className="list-disc">
                읽음: 메시지 수신에 성공한 고객 중 해당 메시지를 실제로
                열람한 건수입니다.
              </li>
              <li className="list-disc">
