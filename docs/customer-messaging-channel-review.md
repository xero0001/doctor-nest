...
닥터네스트 개인정보처리방침에는 인포뱅크가 `카카오 브랜드 메시지 발송 및 상담톡 연동` 수탁사로 명시되어 있다. DoctorNest도 동일하게 공식 딜러는 전송망으로만 사용하고, 상담 제품은 자체 구축할 수 있다.
...
- [닥터네스트 개인정보처리방침](https://www.doctornest.ai/docs/privacy-policy)
